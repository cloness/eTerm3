			...
			<TD>
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: Times New Roman">NAME:<xsl:value-of select="PASSENGERLIST/PASSENGER/NAME"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">ETKT NBR:<xsl:value-of select="TICKETS/TICKETINFO/TKTN"/>
								</span>
							</td>
						</tr>
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: Times New Roman">ID NUMBER:<xsl:value-of select="PASSENGERLIST/PASSENGER/IDCARD/CARDTYPE"/>
									<xsl:value-of select="PASSENGERLIST/PASSENGER/IDCARD/CARDNUMBER"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">CONJ NBR:<xsl:value-of select="TICKETS/TICKETINFO/CONJTKT"/>
								</span>
							</td>
						</tr>
						<TR>
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: Times New Roman">
									<span style="font-size: 12.0pt; font-family: Times New Roman; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">ISSUING AIRLINE:</span>
				...
				<table border="0" width="599" cellSpacing="1">
					<TBODY>
						...
						<TR>
							<TD width="591" colSpan="2">
								<P class="MsoNormal">
									<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">RESTRICTIONS:
</SPAN>
									<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">
			...
			<table border="0" cellSpacing="1" width="100%">
				<TBODY>
					<TR>
						...
						<TD align="middle" width="52">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">FLIGHT NO</SPAN>
						</TD>
						<TD align="middle" width="61">
						...
						<TD align="middle" width="64">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">PERIOD</SPAN>
						</TD>
						<TD align="middle" width="81">
