...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="NORMAL">
		...
		<xsl:if test="count(LEGS/LEG)=1">
			...
			<TR>
				...
				<TD width="50%">到達時間：<xsl:value-of select="DATE"/>
	...
	<xsl:template match="INFO">
		...
		<xsl:if test="count(LEGS/LEG)=1">
			...
			<TR>
				...
				<TD width="50%">到達時間：<xsl:value-of select="LEGS/LEG/ARRTIME"/>
				</TD>
			</TR>
			<TR>
				<TD width="50%">飛行時間：<xsl:value-of select="ELAPSEDTIME"/>
		...
		<xsl:if test="count(LEGS/LEG)>1">
			...
			<TR>
				...
				<TD width="50%">到達時間：<xsl:value-of select="LEGS/LEG[last()]/ARRTIME"/>
				</TD>
			</TR>
			<TR>
				<TD width="50%">飛行時間：<xsl:value-of select="ELAPSEDTIME"/>
	...
	<xsl:template match="ARNK">
		...
		<TR>
			...
			<TD width="50%">到達時間：<xsl:value-of select="ARRTIME"/>
			</TD>
		</TR>
		<TR>
			<TD width="50%">飛行時間：<xsl:value-of select="ELAPSEDTIME"/>
