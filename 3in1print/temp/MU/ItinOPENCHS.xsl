							...
							<TD>
								<table border="0" width="599" cellSpacing="1">
									<TBODY>
										...
										<TR>
											<TD width="397">
												<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">付款方式：<xsl:value-of select="/Response/PNR/FPs/FP/FP1/CashOrCheck"/>
										...
										<TR>
											<TD width="591" colSpan="2">
												<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">机票款：<xsl:value-of select="/Response/PNR/FNs/FN/fcur/price"/>
										...
										<TR>
											<TD width="591" colSpan="2">
												<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">总 额：<xsl:value-of select="/Response/PNR/FNs/FN/acur/price"/>
				...
				<TBODY>
					<TR>
						...
						<TD align="middle" width="52">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">乘运人</SPAN>
						</TD>
						<TD align="middle" width="61">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">航班号</SPAN>
						</TD>
						<TD align="middle" width="70">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">座位等级</SPAN>
						</TD>
						<TD align="middle">
						...
						<TD align="middle" width="81">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">座位状态</SPAN>
						</TD>
						<TD align="middle" width="60">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">座位数</SPAN>
						</TD>
					</TR>
					<TR>
