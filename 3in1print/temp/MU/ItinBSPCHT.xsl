							...
							<td>
								<table border="0" width="100%" id="table5" cellspacing="1">
									<tr>
										...
										<td width="49%">
											<p align="right">
												<span style="font-size: 12.0pt; font-family: 宋體">MU ET</span>
											</p>
										</td>
									</tr>
									<tr>
										<td colspan="2">
											...
											<p class="MsoNormal" align="center" style="text-	align:center">
												<span style="font-size: 16.0pt; font-family: 宋體">電子客票行程單</span>
											</p>
								　		</td>
									</tr>
								</table>
			...
			<TD>
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
							...
							<xsl:choose>
								<xsl:when test="$system='1E'">
									<td width="399">
										...
										航空公司記錄編號:<xsl:value-of select="PNRNO"/>
										</span>
									</td>
									<td>
										<span style="font-size: 12.0pt; font-family: 宋體">
										訂座記錄編號:<xsl:value-of select="AIRLINEPNRNO"/>
										</span>
									</td>
								</xsl:when>
								<xsl:otherwise>
									<td width="399">
										<span style="font-size: 12.0pt; font-family: 宋體">
										航空公司記錄編號:<xsl:value-of select="AIRLINEPNRNO"/>
										</span>
									</td>
									<td>
										<span style="font-size: 12.0pt; font-family: 宋體">
										訂座記錄編號:<xsl:value-of select="PNRNO"/>
										</span>
									</td>
								</xsl:otherwise>
							</xsl:choose>
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">旅客姓名：<xsl:value-of select="PASSENGERLIST/PASSENGER/NAME"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">票號：<xsl:value-of select="TICKETS/TICKETINFO/TKTN"/>
								</span>
							</td>
						</tr>
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">身份識別代碼：<xsl:value-of select="PASSENGERLIST/PASSENGER/IDCARD/CARDTYPE"/>
									<xsl:value-of select="PASSENGERLIST/PASSENGER/IDCARD/CARDNUMBER"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">聯票：<xsl:value-of select="TICKETS/TICKETINFO/CONJTKT"/>
								</span>
							</td>
						</tr>
						<TR>
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">
									<span style="font-size: 12.0pt; font-family: 宋體; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">出票航空公司：</span>
									<xsl:value-of select="TICKETS/TICKETINFO/ISSUEDBY"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">
									<span style="font-size: 12.0pt; font-family: 宋體; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">出票時間：</span>
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">
									<span style="font-size: 12.0pt; font-family: 宋體; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">出票代理人：</span>
									<xsl:value-of select="AGENTINFO/NAME"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">
									<span style="font-size: 12.0pt; font-family: 宋體; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">航協代碼：</span>
						...
						<tr>
							<td colSpan="2">
								<span style="font-size: 12.0pt; font-family: 宋體">
									<span style="font-size: 12.0pt; font-family: 宋體; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">代理人地址：</span>
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">
									<span style="font-size: 12.0pt; font-family: 宋體; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">電話：</span>
									<xsl:value-of select="AGENTINFO/CONTACTINFO/PHONE"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">
									<span style="font-size: 12.0pt; font-family: 宋體; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">傳真：</span>
					...
					<TBODY>
						...
						<TR>
							<TD width="637" colSpan="2" height="18">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">票價計算：</SPAN>
							</TD>
						</TR>
						<TR>
							<TD style="WORD-BREAK: break-all; WORD-WRAP: break-word" width="637" colSpan="2" height="18">
								<BLOCKQUOTE>
									<P class="MsoNormal">
										<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋體">
						...
						<TR>
							<TD width="397">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">付款方式：<xsl:value-of select="FPS/FP/PAYMENTTYPE"/>
								</SPAN>
							</TD>
							<TD width="188">
								<td width="60">
						...
						<TR>
							<TD width="591" colSpan="2">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">機票款：<xsl:value-of select="FARES/FARE/TICKETFARE/CURRENCY"/>
						...
						<TR>
							<TD width="591" colSpan="2">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">總 額：<xsl:value-of select="FARES/FARE/TOTALFARE/CURRENCY"/>
						...
						<TR>
							<TD width="591" colSpan="2">
								<P class="MsoNormal">
									<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">限制條件：</SPAN>
									<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">
			...
			<table border="0" cellSpacing="1" width="100%">
				<TBODY>
					<TR>
						...
						<TD align="middle" width="64">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">有效日期</SPAN>
						</TD>
						<TD align="middle" width="81">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">客票狀態</SPAN>
						</TD>
						<TD align="middle" width="60">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">行李</SPAN>
						</TD>
					</TR>
					<TR>
	...
	<xsl:template match="NOTICE/ATTENTION">
		<TR>
			<TD>
				<P class="MsoNormal">
					<B>
						<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">注意：<xsl:value-of select="."/>
						</SPAN>
					</B>
				</P>
			</TD>
								...
								<xsl:if test="CHSINFO!=''">
									<li>
										<SPAN style="FONT-SIZE: 10.5pt;FONT-FAMILY:  宋體; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman">
											...
											<xsl:value-of select="MFLIGHTNO"/>
											/<xsl:value-of select="MDATE"/>
											:<xsl:value-of select="CHSINFO"/>
										</SPAN>
									</li>
								</xsl:if>
							</xsl:for-each>
