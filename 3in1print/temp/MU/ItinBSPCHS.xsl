							...
							<td>
								<table border="0" width="100%" id="table5" cellspacing="1">
									<tr>
										...
										<td width="49%">
											<p align="right">
												<span style="font-size: 12.0pt; font-family: 宋体">MU ET</span>
											</p>
										</td>
									</tr>
									<tr>
										<td colspan="2">
											...
											<p class="MsoNormal" align="center" style="text-	align:center">
												<span style="font-size: 16.0pt; font-family: 宋体">电子客票行程单</span>
											</p>
								　		</td>
									</tr>
								</table>
			...
			<TD>
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋体">旅客姓名：<xsl:value-of select="PASSENGERLIST/PASSENGER/NAME"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">票号：<xsl:value-of select="TICKETS/TICKETINFO/TKTN"/>
								</span>
							</td>
						</tr>
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋体">身份识别代码：<xsl:value-of select="PASSENGERLIST/PASSENGER/IDCARD/CARDTYPE"/>
									<xsl:value-of select="PASSENGERLIST/PASSENGER/IDCARD/CARDNUMBER"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">联票：<xsl:value-of select="TICKETS/TICKETINFO/CONJTKT"/>
								</span>
							</td>
						</tr>
						<TR>
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋体">
									<span style="font-size: 12.0pt; font-family: 宋体; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">出票航空公司：</span>
									<xsl:value-of select="TICKETS/TICKETINFO/ISSUEDBY"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">
									<span style="font-size: 12.0pt; font-family: 宋体; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">出票时间：</span>
						...
						<tr>
							...
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">
									<span style="font-size: 12.0pt; font-family: 宋体; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">航协代码：</span>
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋体">
									<span style="font-size: 12.0pt; font-family: 宋体; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">电话：</span>
									<xsl:value-of select="AGENTINFO/CONTACTINFO/PHONE"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">
									<span style="font-size: 12.0pt; font-family: 宋体; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">传真：</span>
					...
					<TBODY>
						...
						<TR>
							<TD width="637" colSpan="2" height="18">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">票价计算：</SPAN>
							</TD>
						</TR>
						<TR>
						...
						<TR>
							<TD width="397">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">付款方式：<xsl:value-of select="FPS/FP/PAYMENTTYPE"/>
								</SPAN>
							</TD>
							<TD width="188">
								<td width="60"><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">税款：</SPAN></td>
								<td width="128"><table border="0" width="100%" cellSpacing="2">
						...
						<TR>
							<TD width="591" colSpan="2">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">机票款：<xsl:value-of select="FARES/FARE/TICKETFARE/CURRENCY"/>
						...
						<TR>
							<TD width="591" colSpan="2">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">总 额：<xsl:value-of select="FARES/FARE/TOTALFARE/CURRENCY"/>
						...
						<TR>
							<TD width="591" colSpan="2">
								<P class="MsoNormal">
									<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">限制条件：</SPAN>
									<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">
				...
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
						<TR>
							<TD>
								<P class="MsoNormal">
									<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">须知：</SPAN>
								</P>
		...
		<TD>
			<table border="0" cellSpacing="1" width="100%">
				<TBODY>
					<TR>
						<TD align="middle" width="110">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">始发地</SPAN>
							<SPAN lang="EN-US" style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">/</SPAN>
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">目的地</SPAN>
						</TD>
						<TD align="middle" width="52">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">航班号</SPAN>
						</TD>
						<TD align="middle" width="61">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">舱位</SPAN>
						</TD>
						<TD align="middle" width="70">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">日期</SPAN>
						</TD>
						<TD align="middle">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">时间</SPAN>
						</TD>
						<TD align="middle" width="64">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">有效日期</SPAN>
						</TD>
						<TD align="middle" width="81">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">状态</SPAN>
						</TD>
	...
	<xsl:template match="NOTICE/ATTENTION">
		<TR>
			<TD>
				<P class="MsoNormal">
					<B>
						<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">注意：<xsl:value-of select="."/>
						</SPAN>
					</B>
				</P>
			</TD>
