									...
									<tr>
										<td colspan="2">
											...
											<p class="MsoNormal" align="center" style="text-	align:center">
												<span style="font-size: 16.0pt; font-family: 宋体">行程单</span>
											</p>
								　		</td>
									</tr>
								</table>
				...
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
						...
						<tr>
							...
							<td width="30%">
								<span style="fort-size: 12.Opt; font-family: 宋体">身份识别代码：</span>
							</td>
							<td width="20%">
								<span style="font-size: 12.0pt; font-family: 宋体">旅客姓名：</span>
							</td>
						...
						<tr>
							<td colspan="2">
								<span style="font-size: 12.0pt; font-family: 宋体">票号：
							...
							<td colspan="2">
								<span style="font-size: 12.0pt; font-family: 宋体">联票：
						...
						<tr>
							<td colspan="4">
								<span style="font-size: 12.0pt; font-family: 宋体">
									<span style="font-size: 12.0pt; font-family: 宋体; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA">出票航空公司：中国东方航空公司</span>
								</span>
							</td>
							<!--
							<td colspan="2">
