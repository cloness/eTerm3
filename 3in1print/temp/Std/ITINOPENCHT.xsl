									...
									<TBODY>
										...
										<TR>
											<TD width="591" colSpan="2">
												<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">機票款：<xsl:value-of select="/Response/PNR/FNs/FN/fcur/price"/>
										...
										<TR>
											<TD width="591" colSpan="2">
												<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">總 額：<xsl:value-of select="/Response/PNR/FNs/FN/acur/price"/>
				...
				<TBODY>
					<TR>
						...
						<TD align="middle" width="81">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">座位狀態</SPAN>
						</TD>
						<TD align="middle" width="60">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">座位數</SPAN>
						</TD>
					</TR>
					<TR>
