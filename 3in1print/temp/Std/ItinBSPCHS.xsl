									...
									<tr>
										<td colspan="2">
											...
											<p align="center" style="text-	align:center">
												<span style="font-size: 16.0pt; font-family: Times New Roman; font-weight: bold;">电子客票行程单</span>
											</p>
								　		</td>
									</tr>
								</table>
				...
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
						...
						<tr>
							...
							<xsl:choose>
								<xsl:when test="$system='1E'">
									<td width="399">
										<span style="font-size: 12.0pt; font-family: Times New Roman">航空公司记录编号:</span>
										<span style="font-size: 10.5pt; font-family: Times New Roman">
											<xsl:value-of select="PNRNO"/>
										</span>
									</td>
									<td>
										<span style="font-size: 12.0pt; font-family: Times New Roman">订座记录编号:</span>
										<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							...
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">票号：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: Times New Roman">身份识别代码：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
							...
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">联票：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							...
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">出票时间：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							...
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">航协代码：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: Times New Roman">电话：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
									<xsl:value-of select="AGENTINFO/CONTACTINFO/PHONE"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">传真：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
			...
			<td>
				<table border="0" cellSpacing="1">
					<TBODY>
						...
						<tr>
							<td colSpan="4">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">机票款：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: Times New Roman">
						...
						<tr>
							<td colSpan="4">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">总 额：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: Times New Roman">
