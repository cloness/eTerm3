													...
													<tr>
														...
														<td rowspan="2" width="65%">
															<xsl:for-each select="Response/ITINERARY/HotelResponse/DayWeather/description/Weather">
																<xsl:if test="position() != 1">転</xsl:if>
																<xsl:element name="IMG">
									...
									<tr>
										<td colspan="2">
											...
											<p align="center" style="text-	align:center">
												<span style="font-size: 16.0pt; font-family: Times New Roman; font-weight: bold;">Eチケットアイテナリー</span>
											</p>
								　		</td>
									</tr>
								</table>
				...
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
						...
						<tr>
							...
							<xsl:choose>
								<xsl:when test="$system='1E'">
									<td width="399">
										<span style="font-size: 12.0pt; font-family: Times New Roman">航空会社用リファレンス番号:</span>
										<span style="font-size: 10.5pt; font-family: Times New Roman">
											<xsl:value-of select="PNRNO"/>
										</span>
									</td>
									<td>
										<span style="font-size: 12.0pt; font-family: Times New Roman">予約リファレンス番号:</span>
										<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							...
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">チケット番号：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: Times New Roman">身分証明書識別番号：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
							...
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">クーポン：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: Times New Roman">航空会社発券：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
									<xsl:value-of select="TICKETS/TICKETINFO/ISSUEDBY"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">発券時間：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: Times New Roman">発券代理店：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
									<xsl:value-of select="AGENTINFO/NAME"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: Times New Roman">航空協会コード：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							<td colSpan="2">
								<span style="font-size: 12.0pt; font-family: Times New Roman">代理店住所：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: Times New Roman">電話番号：</span>
								<span style="font-size: 10.5pt; font-family: Times New Roman">
					...
					<TBODY>
						<tr>
							<td width="650" colSpan="4" height="18">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">運賃計算：</SPAN>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td width="60%" colSpan="2">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">支払い方法：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: Times New Roman">
									<xsl:value-of select="FPS/FP/PAYMENTTYPE"/>
								</SPAN>　
							</td>
							<td width="15%">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">税：</SPAN>
							</td>
							<td width="25%">
						...
						<tr>
							<td colSpan="4">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">航空券：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: Times New Roman">
						...
						<tr>
							<td colSpan="4">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">総額：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: Times New Roman">
						...
						<tr>
							<td colSpan="4">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">制限：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: Times New Roman">
			...
			<td>
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
						<tr>
							<td>
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">注釈：</SPAN>
						...
						<xsl:for-each select="ADVERT/LINE">
							<tr>
								<td style="FONT-SIZE: 9.5pt;FONT-FAMILY: Times New Roman; color:#CCCCCC">
									<xsl:value-of select="."/>
								</td>
							</tr>
						</xsl:for-each>
	...
	<xsl:template match="SEGMENTS">
		...
		<td>
			<table border="0" cellSpacing="1" width="100%">
				<TBODY style="FONT-SIZE: 7.5pt; FONT-FAMILY: Times New Roman">
					<tr>
						<td align="middle" rowspan="2">		出発地点/目的地	</td>
						<td align="middle" rowspan="2">		便名			</td>
						<td align="middle" rowspan="2">		座席等級		</td>
						<td align="middle" rowspan="2">		日付			</td>
						<td align="middle" rowspan="2"> 	出発時間		</td>
						<td align="middle" rowspan="2"> 	到着時間		</td>
						<td align="middle" rowspan="2"> 	有効期限		</td>
						<td align="middle" rowspan="2"> 	チケット状態	</td>
						<td align="middle" rowspan="2">		荷物			</td>
						<td align="middle" colspan="2">		ターミナル		</td>
					</tr>
					<tr>
						<td align="middle">		出発		</td>
						<td align="middle">		到着		</td>
					</tr>
					<tr>
			...
			<td>
				...
				<table width="650" border="0" cellpadding="0" cellspacing="0" style="border: 1pt solid #EEEEEE; font-family: Times New Roman;">
					<tr style="FONT-SIZE: 9.0pt; FONT-FAMILY: Times New Roman;border: 1pt solid #EEEEEE;" height="21">
						<td width="30%" style="border: 1pt solid #EEEEEE; font-weight: bold;"> 人気ホテル </td>
						<td width="30%" style="border: 1pt solid #EEEEEE; font-weight: bold;"> 価格 </td>
						<td width="40%" style="border: 1pt solid #EEEEEE; font-weight: bold;"> 場所 </td>
					</tr>
					<xsl:for-each select="Cities/City">
						<xsl:for-each select="Hotels/Hotel">
							<tr style="FONT-SIZE: 9.0pt; FONT-FAMILY: Times New Roman;">
								<td width="30%" style="border: 1pt solid #EEEEEE;">
									<xsl:value-of select="Name"/>(<xsl:value-of select="HotelRank"/>ランク)
								</td>
