...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="NORMAL">
		...
		<TR>
			<TD width="50%">航班號：<xsl:value-of select="FLIGHTNO"/>
								<xsl:if test="CARRIER!=''">
					(承運:<xsl:value-of select="CARRIER"/>)
					</xsl:if>
			</TD>
			<TD width="50%">艙位：<xsl:value-of select="CLASS"/>
			</TD>
		</TR>
		<xsl:if test="count(LEGS/LEG)=1">
			<TR>
				<TD width="50%">起飛城市：<xsl:value-of select="LEGS/LEG/ORIGIN"/>
				</TD>
				<TD width="50%">到達城市：<xsl:value-of select="LEGS/LEG/DEST"/>
				</TD>
			</TR>
			<TR>
				<TD width="50%">起飛時間：<xsl:value-of select="DATE"/>
				...
				<TD width="50%">到達時間：
					...
					<xsl:value-of select="LEGS/LEG/ARRTIME"/><xsl:value-of select="LEGS/LEG/ARRDATECHG"/>
				</TD>
			</TR>
			<TR>
				<TD width="50%">飛行時間：<xsl:value-of select="ELAPSEDTIME"/>
				</TD>
				<TD width="50%">定座狀態：<xsl:value-of select="SEATSTATUS"/>
				</TD>
			</TR>
			<TR>
				<TD width="50%">餐食：<xsl:value-of select="LEGS/LEG/MEAL"/>
				</TD>
				<TD width="50%">機型：<xsl:value-of select="LEGS/LEG/PLANETYPE"/>
				</TD>
			</TR>
		</xsl:if>
		<xsl:if test="count(LEGS/LEG)>1">
			<TR>
				<TD width="50%">起飛城市：<xsl:value-of select="LEGS/LEG[1]/ORIGIN"/>
				</TD>
				<TD width="50%">到達城市：<xsl:value-of select="LEGS/LEG[last()]/DEST"/>
				</TD>
			</TR>
			<TR>
				<TD width="50%">起飛時間：<xsl:value-of select="DATE"/>
				...
				<TD width="50%">到達時間：
					...
					<xsl:value-of select="LEGS/LEG[last()]/ARRTIME"/><xsl:value-of select="LEGS/LEG[last()]/ARRDATECHG"/>
				</TD>
			</TR>
			<TR>
				<TD width="50%">飛行時間：<xsl:value-of select="ELAPSEDTIME"/>
	...
	<xsl:template match="INFO">
		...
		<xsl:if test="count(LEGS/LEG)=1">
			...
			<TR>
				<TD width="50%">起飛時間：<xsl:value-of select="LEGS/LEG/DEPTIME"/>
				</TD>
				<TD width="50%">到達時間：<xsl:value-of select="LEGS/LEG/ARRTIME"/><xsl:value-of select="LEGS/LEG/ARRDATECHG"/>
				</TD>
			</TR>
			<TR>
				<TD width="50%">飛行時間：<xsl:value-of select="ELAPSEDTIME"/>
		...
		<xsl:if test="count(LEGS/LEG)>1">
			...
			<TR>
				<TD width="50%">起飛時間：<xsl:value-of select="LEGS/LEG[1]/DEPTIME"/>
				</TD>
				<TD width="50%">到達時間：<xsl:value-of select="LEGS/LEG[last()]/ARRTIME"/><xsl:value-of select="LEGS/LEG[last()]/ARRDATECHG"/>
				</TD>
			</TR>
			<TR>
				<TD width="50%">飛行時間：<xsl:value-of select="ELAPSEDTIME"/>
	...
	<xsl:template match="ARNK">
		...
		<TR>
			<TD width="50%">起飛城市：<xsl:value-of select="ORIGIN"/>
			</TD>
			<TD width="50%">到達城市：<xsl:value-of select="DEST"/>
			</TD>
		</TR>
		<TR>
			<TD width="50%">起飛時間：<xsl:value-of select="DEPTIME"/>
			</TD>
			<TD width="50%">到達時間：<xsl:value-of select="ARRTIME"/><xsl:value-of select="ARRDATECHG"/>
			</TD>
		</TR>
		<TR>
			<TD width="50%">飛行時間：<xsl:value-of select="ELAPSEDTIME"/>
	...
	<xsl:template match="OPEN">
		...
		<TR>
			...
			<TD width="50%">機型：<xsl:value-of select="PLANETYPE"/>
			</TD>
		</TR>
	</xsl:template>
