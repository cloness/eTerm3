...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
										...
										<td width="40%">
											...
											<xsl:if test="Response/ITINERARY/HotelResponse/DayWeather != ''">
												<table border="0" cellspacing="1" width="100%" align="right">
													<tr>
														<td width="10%" style="font-size: 9pt; font-family: 宋體;">
														...
														<td width="25%" style="font-size: 9pt; font-family: 宋體;">
													...
													<tr>
														<td style="font-size: 9pt; font-family: 宋體;">
									...
									<tr>
										<td colspan="2">
											...
											<p align="center" style="text-	align:center">
												<span style="font-size: 16.0pt; font-family: 宋體; font-weight: bold;">電子客票行程單</span>
											</p>
								　		</td>
									</tr>
								</table>
			...
			<td>
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
						...
						<tr>
							...
							<xsl:choose>
								<xsl:when test="$system='1E'">
									<td width="399">
										<span style="font-size: 12.0pt; font-family: 宋體">航空公司記錄編號:</span>
										<span style="font-size: 10.5pt; font-family: 宋體">
											<xsl:value-of select="PNRNO"/>
										</span>
									</td>
									<td>
										<span style="font-size: 12.0pt; font-family: 宋體">訂座記錄編號:</span>
										<span style="font-size: 10.5pt; font-family: 宋體">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">旅客姓名：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
									<xsl:value-of select="PASSENGERLIST/PASSENGER/NAME"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">票號：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">身份識別代碼：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
							...
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">聯票：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">出票航空公司：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
									<xsl:value-of select="TICKETS/TICKETINFO/ISSUEDBY"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">出票時間：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">出票代理人：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
									<xsl:value-of select="AGENTINFO/NAME"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">航協代碼：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
						...
						<tr>
							<td colSpan="2">
								<span style="font-size: 12.0pt; font-family: 宋體">代理人地址：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋體">電話：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
									<xsl:value-of select="AGENTINFO/CONTACTINFO/PHONE"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋體">傳真：</span>
								<span style="font-size: 10.5pt; font-family: 宋體">
					...
					<TBODY>
						...
						<tr>
							<td width="60%" colSpan="2">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">付款方式：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋體">
						...
						<tr>
							<td colSpan="4">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">機票款：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋體">
						...
						<tr>
							<td colSpan="4">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">總 額：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋體">
	...
	<xsl:template match="NORMAL">
		...
		<xsl:for-each select="LEGS/LEG">
			<tr style="font-size: 9.0pt; font-family: 宋體">
				<td align="middle">
	...
	<xsl:template match="OPEN">
		<tr style="font-size: 10.5pt; font-family: 宋體">
			<td align="middle">
				<xsl:value-of select="ORIGIN"/>
			</td>
			<td align="middle">
	...
	<xsl:template match="SEGMENTS">
		...
		<td>
			<table border="0" cellSpacing="1" width="100%">
				<TBODY style="FONT-SIZE: 10pt; FONT-FAMILY: 宋體">
					<tr>
	...
	<xsl:template match="NOTICE/ATTENTION">
		<tr>
			<td>
				<B>
					<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋體">注意：</SPAN>
					<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋體">
						<xsl:value-of select="."/>
					</SPAN>
				</B>
		...
		<xsl:if test="FLTINFO/CHSINFO!=''">
			...
			<td>
				<table border="0" width="599" cellSpacing="1">
					<TBODY>
						<td style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋體;">
	...
	<xsl:template match="HotelResponse">
		<xsl:if test="Cities !=''">
			...
			<td>
				...
				<table width="650" border="0" cellpadding="0" cellspacing="0" style="border: 1pt solid #EEEEEE; font-family: 宋體;">
					<tr style="FONT-SIZE: 9.0pt; FONT-FAMILY: 宋體;border: 1pt solid #EEEEEE;" height="21">
					...
					<tr>
						<td colspan="3" align="right" style="FONT-SIZE: 9pt; FONT-FAMILY: 宋體;border: 1pt solid #EEEEEE;">
