							...
							<TD>
								<table border="0" width="599" cellSpacing="1">
									<TBODY>
										...
										<TR>
											<TD width="397">
												<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">支払い方法：<xsl:value-of select="/Response/PNR/FPs/FP/FP1/CashOrCheck"/>
										...
										<TR>
											<TD width="591" colSpan="2">
												<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">航空券：<xsl:value-of select="/Response/PNR/FNs/FN/fcur/price"/>
										...
										<TR>
											<TD width="591" colSpan="2">
												<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">総額：<xsl:value-of select="/Response/PNR/FNs/FN/acur/price"/>
										...
										<TR>
											<TD>
												...
												<P class="MsoNormal" style="MARGIN-LEFT: 21pt; TEXT-INDENT: -21pt; mso-list: l0 level1 lfo1; tab-stops: list 21.0pt">
													...
													<SPAN style="FONT-FAMILY: Times New Roman; mso-ascii-font-family: Times New Roman; mso-hansi-font-family: Times New Roman">
				...
				<TBODY>
					<TR>
						<TD align="middle" width="110">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">出発地点</SPAN>
						...
						<TD align="middle" width="52">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">航空会社</SPAN>
						</TD>
						<TD align="middle" width="61">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">便名</SPAN>
						</TD>
						<TD align="middle" width="70">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">座席等級</SPAN>
						</TD>
						<TD align="middle">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">日付</SPAN>
						</TD>
						<TD align="middle" width="64">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">時間</SPAN>
						</TD>
						<TD align="middle" width="81">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">座席ステータス</SPAN>
						</TD>
						<TD align="middle" width="60">
							<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: Times New Roman">座席数</SPAN>
						</TD>
					</TR>
					<TR>
