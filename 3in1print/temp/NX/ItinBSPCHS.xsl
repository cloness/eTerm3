...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
										...
										<td width="40%">
											...
											<xsl:if test="Response/ITINERARY/HotelResponse/DayWeather != ''">
												<table border="0" cellspacing="1" width="100%" align="right">
													<tr>
														<td width="10%" style="font-size: 9pt; font-family: 宋体;">
														...
														<td rowspan="2" width="65%">
															<xsl:for-each select="Response/ITINERARY/HotelResponse/DayWeather/description/Weather">
																<xsl:if test="position() != 1">转</xsl:if>
																<xsl:element name="IMG">
																	<xsl:attribute name="src">Weather\<xsl:value-of select="."/>.gif</xsl:attribute>
																</xsl:element>
															</xsl:for-each>
														</td>
														<td width="25%" style="font-size: 9pt; font-family: 宋体;">
													...
													<tr>
														<td style="font-size: 9pt; font-family: 宋体;">
									...
									<tr>
										<td colspan="2">
											...
											<p align="center" style="text-	align:center">
												<span style="font-size: 16.0pt; font-family: 宋体; font-weight: bold;">电子客票行程单</span>
											</p>
								　		</td>
									</tr>
								</table>
				...
				<TABLE cellSpacing="1" width="100%" border="0">
					<TBODY>
						...
						<tr>
							...
							<xsl:choose>
								<xsl:when test="$system='1E'">
									<td width="399">
										<span style="font-size: 12.0pt; font-family: 宋体">航空公司记录编号:</span>
										<span style="font-size: 10.5pt; font-family: 宋体">
											<xsl:value-of select="PNRNO"/>
										</span>
									</td>
									<td>
										<span style="font-size: 12.0pt; font-family: 宋体">订座记录编号:</span>
										<span style="font-size: 10.5pt; font-family: 宋体">
						...
						<tr>
							...
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">票号：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋体">身份识别代码：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
							...
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">联票：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋体">出票航空公司：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
									<xsl:value-of select="TICKETS/TICKETINFO/ISSUEDBY"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">出票时间：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋体">出票代理人：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
									<xsl:value-of select="AGENTINFO/NAME"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">航协代码：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
						...
						<tr>
							<td colSpan="2">
								<span style="font-size: 12.0pt; font-family: 宋体">代理人地址：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
						...
						<tr>
							<td width="399">
								<span style="font-size: 12.0pt; font-family: 宋体">电话：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
									<xsl:value-of select="AGENTINFO/CONTACTINFO/PHONE"/>
								</span>
							</td>
							<td>
								<span style="font-size: 12.0pt; font-family: 宋体">传真：</span>
								<span style="font-size: 10.5pt; font-family: 宋体">
					...
					<TBODY>
						...
						<tr>
							<td width="60%" colSpan="2">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">付款方式：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋体">
						...
						<tr>
							<td colSpan="4">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">机票款：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋体">
						...
						<tr>
							<td colSpan="4">
								<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">总 额：</SPAN>
								<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋体">
		...
		<xsl:for-each select="LEGS/LEG">
			<tr style="font-size: 9.0pt; font-family: 宋体">
				...
				<td align="middle">
					...
					<xsl:if test="$CARRIER!=''">
					<br/>(承运:<xsl:value-of select="$CARRIER"/>)
					</xsl:if>
				</td>
				<td align="middle">
	...
	<xsl:template match="OPEN">
		<tr style="font-size: 10.5pt; font-family: 宋体">
			<td align="middle">
				<xsl:value-of select="ORIGIN"/>
			</td>
			<td align="middle">
	...
	<xsl:template match="SEGMENTS">
		...
		<td>
			<table border="0" cellSpacing="1" width="100%">
				<TBODY style="FONT-SIZE: 10pt; FONT-FAMILY: 宋体">
					<tr>
						<td align="middle" rowspan="2">		始发地/目的地	</td>
						<td align="middle" rowspan="2">		航班			</td>
						<td align="middle" rowspan="2">		座位等级		</td>
						<td align="middle" rowspan="2">		日期			</td>
						<td align="middle" rowspan="2"> 	起飞时间		</td>
						<td align="middle" rowspan="2"> 	到达时间		</td>
						<td align="middle" rowspan="2"> 	有效期			</td>
						<td align="middle" rowspan="2"> 	客票状态		</td>
						<td align="middle" rowspan="2">		行李			</td>
						<td align="middle" colspan="2">		航站楼		</td>
					</tr>
					<tr>
						<td align="middle">		起飞		</td>
						<td align="middle">		到达		</td>
					</tr>
					<tr>
	...
	<xsl:template match="NOTICE/ATTENTION">
		<tr>
			<td>
				<B>
					<SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 宋体">注意：</SPAN>
					<SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋体">
						<xsl:value-of select="."/>
					</SPAN>
				</B>
		...
		<xsl:if test="FLTINFO/CHSINFO!=''">
			...
			<td>
				<table border="0" width="599" cellSpacing="1">
					<TBODY>
						<td style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋体;">
	...
	<xsl:template match="HotelResponse">
		<xsl:if test="Cities !=''">
			...
			<td>
				...
				<table width="650" border="0" cellpadding="0" cellspacing="0" style="border: 1pt solid #EEEEEE; font-family: 宋体;">
					<tr style="FONT-SIZE: 9.0pt; FONT-FAMILY: 宋体;border: 1pt solid #EEEEEE;" height="21">
						<td width="30%" style="border: 1pt solid #EEEEEE; font-weight: bold;"> 推荐酒店 </td>
						<td width="30%" style="border: 1pt solid #EEEEEE; font-weight: bold;"> 价格 </td>
						...
						<xsl:for-each select="Hotels/Hotel">
							<tr style="FONT-SIZE: 9.0pt; FONT-FAMILY: 宋体;">
								<td width="30%" style="border: 1pt solid #EEEEEE;">
									<xsl:value-of select="Name"/>(<xsl:value-of select="HotelRank"/>级)
								</td>
					...
					<tr>
						<td colspan="3" align="right" style="FONT-SIZE: 9pt; FONT-FAMILY: 宋体;border: 1pt solid #EEEEEE;">
